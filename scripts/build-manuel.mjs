// Prépare le manuel pour le site Vercel (`npm run build` → `dist/`, servi à `/manuel.html` et
// `/manuel.pdf` sur le domaine de production du projet — à confirmer, voir README § Site).
//
